...
export default function CreateDeal({ isOpen, onClose, onSave }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await onSave(newDeal); // ✅ now it works
                ...
                <div className="drawer-body p-4">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-select" name="stage" value={deal.stage} onChange={handleChange}>
                            ...
                            {errors.stage && <div style={{ color: "red", fontSize: "0.9em" }}>{errors.stage}</div>}
                        </div>
                        ...
                        <div className="mb-3">
                            ...
                            <select className="form-select" name="dealOwner" value={deal.dealOwner} onChange={handleChange}>
                                <option value="">Choose</option>
                                {users.map((user) => (
                            ...
                            {errors.dealOwner && <div style={{ color: "red", fontSize: "0.9em" }}>{errors.dealOwner}</div>}
                        </div>
                                ...
                                <div className="position-relative" style={{ width: "100%" }}>
                                    ...
                                    >
                                        <span className="text-muted">
                                            {deal.closeDate ? formatDate(deal.closeDate) : "Close Date"}
                                        </span>
